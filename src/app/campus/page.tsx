...
const campusLinks = [
  { icon: "🗺️", title: "校园地图", desc: "教学楼 · 宿舍 · 食堂 · 图书馆", href: "/map", gradient: "linear-gradient(135deg, #4ade80 0%, #22c55e 100%)" },
  { icon: "🍜", title: "食堂美食", desc: "南北口味 · 热门推荐", href: "/cafeteria", gradient: "linear-gradient(135deg, #f97316 0%, #ef4444 100%)" },
  { icon: "📦", title: "快递指南", desc: "快递地址 · 菜鸟驿站", href: "/express", gradient: "linear-gradient(135deg, #86efac 0%, #4ade80 100%)" },
  { icon: "🎯", title: "军训专区", desc: "时间安排 · 注意事项", href: "/military", gradient: "linear-gradient(135deg, #166534 0%, #15803d 100%)" },
  { icon: "🏠", title: "宿舍专区", desc: "房型 · 配置 · 用电", href: "/dormitory", gradient: "linear-gradient(135deg, #86efac 0%, #4ade80 100%)" },
