...
const quickLinks = [
  { icon: "📄", title: "报到流程", desc: "报到时间 · 地点 · 材料", href: "/register", gradient: "linear-gradient(135deg, #4ade80 0%, #22c55e 100%)" },
  { icon: "🏠", title: "宿舍指南", desc: "房型 · 配置 · 用电", href: "/dormitory", gradient: "linear-gradient(135deg, #86efac 0%, #4ade80 100%)" },
  { icon: "🎒", title: "入学准备", desc: "清单 · 物品 · 行李", href: "/packing", gradient: "linear-gradient(135deg, #86efac 0%, #4ade80 100%)" },
  { icon: "👩‍🎓", title: "学姐", desc: "咨询 · 帮助 · 迎新", href: "/senior", gradient: "linear-gradient(135deg, #fa709a 0%, #22c55e 100%)" },
];
  ...
  return (
    <PageTransition>
      ...
      <section className="px-5 mb-8">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            { value: "60年", label: "办学历史", sub: "始于1964", gradient: "linear-gradient(135deg, #4ade80 0%, #22c55e 100%)" },
            { value: "98%", label: "就业率", sub: "常年95%以上", gradient: "linear-gradient(135deg, #86efac 0%, #4ade80 100%)" },
            { value: "100%", label: "推荐报考率", sub: "软科数据", gradient: "linear-gradient(135deg, #86efac 0%, #4ade80 100%)" },
            { value: "10个", label: "国家级骨干专业", sub: "外贸黄埔军校", gradient: "linear-gradient(135deg, #fa709a 0%, #22c55e 100%)" },
          ].map((stat, i) => (
            <motion.div
              key={stat.label}
              initial={{ opacity: 0, y: 16 }}
